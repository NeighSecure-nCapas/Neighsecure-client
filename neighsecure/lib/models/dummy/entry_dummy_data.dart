...
List<Entry> dummyEntries = [
  Entry(
    ...
    terminal: dummyTerminals[0], // Assuming dummyPermissions is a list of Permission objects
    comment: 'Dummy Comment 1',
  ),
  Entry(
    id: '2',
    entryDate: DateTime.now().add(Duration(days: 1)),
    terminal: dummyTerminals[1],// Assuming dummyPermissions is a list of Permission objects
